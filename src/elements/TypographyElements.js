...
export const P = styled.p`
    ...
    font-size: ${props => {
        switch(props.size) {
            ...
            case "samll": return "1rem"
            case "xSamll": return "0.875rem"
    ...
    line-height: ${props => {
        switch(props.size) {
            case "medium": return "1.4375rem"
            case "samll": return "1.375rem"
            case "xSamll": return "1.125rem"
